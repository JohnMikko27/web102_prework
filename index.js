...
const displayString = `A total of $${totalRaised.toLocaleString('en-US')} has been raised for ${GAMES_JSON.length} games. Currently, ${numOfUnfundedGames} ${numOfUnfundedGames === 1 ? "game remains unfunded" : "games remain unfunded"}. We need your help to fund these amazing games!`;
